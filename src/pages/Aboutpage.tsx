        ...
        <div>
            ...
            <div className="dropdownsAbout">
                ...
                <Dropdown title="Respect">
                    ...
                    Kasa. Tout comportement à discriminatoire ou de perturbation
                    du voisinage entraînera un exclusion de notre plateforme.
                </Dropdown>
                <div className="spacer2030" />
                <Dropdown title="Service">
                    ...
                    avec nos hôtes ou nos locataires, soit empreinte de respect
                    et de bienveillance.
                </Dropdown>
                <div className="spacer2030" />
                <Dropdown title="Sécurité">
                    ...
                    une note aussi bien à l’hote qu’au locataire, cela permet à
                    nos équipes de vérifier que les standards sont bien
                    respectés. Nous organisions également des ateliers sur la
                    sécurité domestique pour nos hôtels.
                </Dropdown>
            </div>
        </div>
    );
